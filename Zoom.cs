...
// Most of the code in this file comes from the 2 forum posts above
// The zoom code comes from the top one, and the panning code comes from the bottom one
// I did alter the panning one slightly so the mouse movement isn't inverted
// I also added a couple fields so that I could edit things in the inspector easier
